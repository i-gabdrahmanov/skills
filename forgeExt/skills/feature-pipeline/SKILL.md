...
description: >
  ...
  end-to-end", "forge", "запусти forge", "прогони forge", "forge <фича>" (короткое имя
  этого пайплайна — forge), или описывает идею продукта и хочет довести её до готового
  кода. Аргумент после "forge" (ключ Jira вида STOR-123 либо описание фичи) — это вход

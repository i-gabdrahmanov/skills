...
В каждом каталоге прогона:
  agents.jsonl / agents.log       — всё (главный агент + все субагенты)
  by-agent/<label>.jsonl / .log   — отдельно по каждому агенту (main / <agent_type>-<id8>)

...
```bash
python ~/.gigacode/skills/pipeline-state/scripts/read.py \    --skill system-analysis
```
...
```bash
python ~/.gigacode/skills/pipeline-state/scripts/init.py \    --skill system-analysis \
    --steps '[
...
```bash
python ~/.gigacode/skills/pipeline-state/scripts/update.py \    --skill system-analysis \
    --step-id 02-api \
    --status completed \
    --output-stdin <<'EOF'
...
```bash
python3 ~/.gigacode/skills/system-analyst/scripts/scan_all.py \    -o "<project>/ground/statements/system-analysis/scan"

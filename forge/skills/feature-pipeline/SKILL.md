...
(контракт — §4.0 subagent-prompts.md). Он напишет `brd.md` в `docs/feature-pipeline/<slug>/`
...
agent(subagent_type="general-purpose", description="draft BRD for <slug>",
      prompt="<контракт §4.0 subagent-prompts.md; подставь: slug, Jira-ключ, идею, ответы интервью, grounding>")
```
...
Запусти субагента по контракту §4.5 subagent-prompts.md (он сам прочитает task-plan.json,
brd.md, pipeline.json по путям):
```
agent(subagent_type="general-purpose",
      description="Jira tasks for <slug>",
      prompt="<контракт §4.5 subagent-prompts.md; подставь: пути к task-plan/brd/pipeline.json, slug>")
```

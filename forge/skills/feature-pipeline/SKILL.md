...
Если проблема глубже одной фазы (гейт SDD вскрыл новое бизнес-требование → откат к BRD;
дизайн нежизнеспособен после провалов сборки сверх лимитов) — не крути ре-итерации, предложи

...
>
> **Гейт закрытия фазы:** `check_brd_doc.py` PASS (детерминированный хард-гейт) + Гейт 1 (пользователь утвердил BRD) + brd-judge advisory + гейт критичности; закрой шаг 00-brd

...
ROOT = HOOKS.parent  # корень forge; используется в _is_phase_work для резолвинга pipeline.json
...
REPRESENTATIVE = {
    ...
    "lite-design": ("lite-design", "Write", {"file_path": "docs/feature-pipeline/f/tech-design.md"}),
        ...
        for prefix in pp.SUBAGENT_PHASE_PREFIXES:
            with self.subTest(prefix=prefix):
                ...
                self.assertIsNotNone(
                    IPG._is_phase_work(step_id, tool, tin, ROOT),
